	...
	<div class="contact">				
				<div class="contact_center">
      			...
      			<div class="company_address">
		     	  <h1>Find Us Here :</h1>
                  <h2>MIM GONILAN KARTASURA SUKOHARJO				 	 	</p></h2>
				   		<p>Email: <a href="mailto:mimginilankartasura@yahoo.co.id">mimgonilankartasura(at)yahoo.co.id</a></p>
				   		<p>Telp : (0271) 730749, 08179497234</p>
			      </div>		
			  <div class="clear"></div>		
		  </div>
</div>
