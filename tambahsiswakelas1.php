...
<div class="wrap">
<div class="main_top">
	<h2 class="style">Silahkan Memasukkan Data Siswa</h2>
</div>
</div>
</div>
<!-- start main -->
...
<div class="main">
	<div class="about">
			 <form action="simpantambahsiswakelas1.php" method="post" enctype="multipart/form-data">
<table>
<tr>
	<td>NO</td><td>:</td>
...
<tr>
	<td>Nama Orangtua</td><td>:</td>
	<td><input type="text" name="namaorangtua" /></td>
</tr>
<tr>
	<td>Alamat</td><td>:</td>
...
<tr>
	<td><input type="submit" name="simpan" value="Simpan" /></td><td></td>
