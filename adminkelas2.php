...
<div id='cssmenu'>
<ul>
   <li class='active '><a href='index1.html'><span>Home</span></a></li>
   <li class='has-sub '><a href='about.html'><span>Profil</span></a>
...
<div class="wrap">
<div class="main_top">
	<h2 class="style">Daftar Siswa</h2>
</div>
</div>
</div>
<!-- start main -->
...
<div class="about">	
<center>
					<form action="tambahsiswakelas2.php" method="post" align="center">
...
while($data = mysql_fetch_array($sql))
 ...
 $i++;
		...
		<tr>
			...
			<td>$data[alamat]</td>
			<td><a href='hapusdaftarsiswakelas2.php?nama=$data[nama]'>Hapus</a>|
			<a href='editdaftarsiswakelas2.php?no=$data[id]'>Edit</a></td></td>
		</tr>";
