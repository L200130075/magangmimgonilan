...
<div class="about">	
<center>
					<form action="tambahsiswakelas5.php" method="post" align="center">
...
while($data = mysql_fetch_array($sql))
 ...
 $i++;
		...
		<tr>
			...
			<td>$data[alamat]</td>
			<td><a href='hapusdaftarsiswakelas5.php?nama=$data[nama]'>Hapus</a>|
			<a href='editdaftarsiswakelas5.php?no=$data[id]'>Edit</a></td></td>
		</tr>";
