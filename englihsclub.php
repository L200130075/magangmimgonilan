    ...
    <li class='has-sub '><a href='#'><span>Anggota Sekolah</span></a>
            <ul>
               ...
               <li class='has-sub'><a href='#'><span>Siswa</span></a>
					<ul>
						<li><a href='daftarsiswa.php'><span>Kelas I</span></a></li>
						<li><a href='daftarsiswa.php'><span>Kelas II</span></a></li>
						<li><a href='daftarsiswa.php'><span>Kelas III</span></a></li>
						<li><a href='daftarsiswa.php'><span>Kelas IV</span></a></li>
						<li><a href='daftarsiswa.php'><span>Kelas V</span></a></li>
						<li><a href='daftarsiswa.php'><span>Kelas VI</span></a></li>
					</ul>
					</li>
            </ul>
...
<div class="wrap">
<div class="main_top">
	<h2 class="style">Ekstrakulikuler English Club</h2>
</div>
</div>
</div>
<!-- start main -->
...
<div class="main">
	<div class="about">
			 <div class="cont-grid-img img_style"><img src="images/English Club.JPG" alt="" width="478" height="315"></div>
<div class="cont-grid">
          <p align="justify">Salah satu ekstrakurikuler MIM Gonilan yang menitikberatkan pada keahlian berbahasa Inggris adalah English Club. Seperti yang telah kita ketahui, Bahasa Inggris merupakan bahasa yang paling popular di kalangan masyarakat dunia (general language in the world). Atas dasar itulah, maka diadakannya ekskul EC ini akan sangat membantu para siswa untuk dapat mengembangkan kemampuan berbahasa inggrisnya.
