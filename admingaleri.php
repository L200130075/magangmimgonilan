...
<link href="css/table3.css" rel="stylesheet" type="text/css" media="all" />
<!--- start-mmmenu-script---->
...
<div class="wrap">
	<div class="header">
		<div class="logo">
			<a href="index1.html"><img src="images/thumbs/mimlogoatas.jpg" alt="" width="1100" height="300"/></a>
</div>
		<div class="clear"></div>
	</div>	
</div>
...
<div class="wrap">
<div class="main_top">
	<h2 class="style">Kegiatan Sekolah</h2>
</div>
</div>
</div>
<div class="main_bg">
...
<div class="main">
<center>
					<form action="tambahfoto.php" method="post" align="center">
	  <input type="submit" value="Tambah Foto" name="submit">
	 </form>	</center>			
		<?php
include "conn.php";
?>
...
<?php
$i=0;
$tampil ="select * from galeri order by id ASC";
...
while($data = mysql_fetch_array($sql))
{
	...
	<td>$data[id]</td>
	<td>$data[judul]</td>
	<td><img src=$data[image] weight ='100' height = '100'></td>
	<td><a href='hapusfoto.php?judul=$data[judul]'>Hapus</a></td></tr>";
}
?>
</tbody>
</table>
