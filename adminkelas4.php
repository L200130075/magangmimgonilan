...
<div class="about">	
<center>
					<form action="tambahsiswakelas4.php" method="post" align="center">
...
while($data = mysql_fetch_array($sql))
 ...
 $i++;
		...
		<tr>
			...
			<td>$data[alamat]</td>
			<td><a href='hapusdaftarsiswakelas4.php?nama=$data[nama]'>Hapus</a>|
			<a href='editdaftarsiswakelas4.php?no=$data[id]'>Edit</a></td></td>
		</tr>";
