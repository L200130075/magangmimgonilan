...
<link href="css/table1.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="about">
<center>
					<form action="tambahguru.php" method="post" align="center">
	  <input type="submit" value="Tambah Guru" name="submit">
	 </form>	</center>								
<?php
include "conn.php";
?>
...
while($data = mysql_fetch_array($sql))
 ...
 $i++;
		...
		<tr>
			...
			<td>$data[alamat]</td>
			<td><a href='hapusdaftarguru.php?nama=$data[nama]'>Hapus</a>|
			<a href='editdaftarguru.php?no=$data[id]'>Edit</a></td></td>
		</tr>";
